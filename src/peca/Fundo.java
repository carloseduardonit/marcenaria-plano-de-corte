 ...
 * @author Carlos
 */
public class Fundo extends Peca {

    public Fundo(int quantPeca, long comprimento, long largura, long espessura, String descrição) {
        super(quantPeca, comprimento, largura, espessura, descrição);
    }

    public Fundo(int quantPeca, long comprimento, long largura) {
        super(quantPeca, comprimento, largura, espessuraMDFMM.MM06.espessuraMDF, tipoPeca.FUN.toString());
    }
